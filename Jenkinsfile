pipeline {
  ...
  parameters {
    ...
    string(defaultValue: 'Zadanie2', description: '', name: 'ProjectName', trim: true)
    ...
    stage('Checkout') {
      steps {
        ...
        script {
            ...
            */
            def checkoutVars = checkout([$class: 'GitSCM', branches: [[name: '*/master']], userRemoteConfigs: [[url: 'https://github.com/RustemAston/Zadanie2.git']]])
      ...
      steps {
        ...
        script {
            ...
            if (largestFile != null) {
            	...
            	env.ARTIFACTS = "Zadanie2." + env.VERSION_SEMVER + largestFile.path.substring(largestFile.path.lastIndexOf("."), largestFile.path.length())
